...
class CorpoNotch_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'corponotch';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'corponotch' ), $i ),
...
// Initialize.
$corponotch_footer_widgets = new CorpoNotch_Footer_Widgets();
