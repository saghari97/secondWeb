 ...
 */
Class CorpoNotch_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
 ...
 */
Class CorpoNotch_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class CorpoNotch_Dropdown_Chosen_Control extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="corponotch-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 * @see WP_Customize_Control
 */
class CorpoNotch_Icon_Picker_Control extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="corponotch-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'corponotch' ); ?>" class="corponotch-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
 ...
 * @since  1.0.0
 */
class CorpoNotch_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
 ...
 * @see WP_Customize_Control
 */
Class CorpoNotch_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
...
class CorpoNotch_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="corponotch-sortable-list">
      ...
      ?>
        ...
        <li>
            <input class="corponotch-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $choices[$value] ); ?> </span>
          <i class="dashicons dashicons-menu corponotch-drag-handle"></i>
        </li>
        ...
        <li class="sortable-hideme">
          <input class="corponotch-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
 ...
 * @access public
 */
class CorpoNotch_Customize_Section_Upsell extends WP_Customize_Section {
